...
exe = EXE(
    ...
    strip=False,  # strip.exe is not installed on this Windows box; PyInstaller 6.x treats missing-strip as fatal
    upx=False,  # UPX on a 2.7 GB CUDA+torch bundle is slow, AV-triggering, and pointless for a sidecar that starts once
    upx_exclude=[],
    runtime_tmpdir=None,
